...
TABLE_TEXT_END
     ...
     'KKT' => {
      ...
      :type => '2D6',
      :table => <<'TABLE_TEXT_END'
敗者は、激しく体液をほとばしらせ、糸の切れた操り人形のように突っ伏す。勝者は【生命力】と変調をすべて回復する。(「穢れ」を受けていた場合、それを回復する事もできる)。
敗者の頭の中で小さな爆発が続けざまに起きた。勝者は、敗者が年の忍具を持っているか教えてもらい、そのうち一つを奪うことができる。
敗者は、勝者にすがりつき、声を殺してひしとしがみついた。敗者は、そのセッションの間だけ、勝者に対する命中判定と、勝者の攻撃に対する回避判定にマイナス１の修正がつく。
敗者の身体の芯に痺れるような衝撃が走る。敗者はランダムに選んだ変調を一つ受ける。
敗者は、身体を弓なりにそらせ、ピクピクと震わせた。勝者は、敗者の持つ【情報】の中から、【奥義】以外のものを二つ選び、それを獲得する。
敗者は、身も心も蕩けるような甘美な陶酔のうねりに溺れていた。勝者は、敗者の勝者に対する【感情】を「愛情」か「狂信」にすることができる。
敗者は、かすかな叫びをあげ、四肢をわななかせた。敗者は【生命力】を１点減少する。
敗者は、唇の端から涎を垂らし、壊れた機械のように痙攣する。勝者は、敗者の持っている【感情】一つを選び、それを失わせることができる。
敗者は、狂おしく身もだえして、さらに勝者を求めた。敗者がＮＰＣだった場合、そのセッションの間だけ、勝者の「従者」にすることができる。
敗者は、苦悶にも似た表情を浮かべながら、ふいごのように息を吐いて許しを請うた。勝者は、敗者の【奥義】の【情報】を一つ獲得する(奥義を二つ以上持つ場合、まだ獲得していない【奥義】の【情報】の中からランダムに決定)。
敗者は、恍惚とした三白眼になって、獣じみたうなり声をはりあげた。敗者は妖魔化する。
TABLE_TEXT_END
    },
  }

  setPrefixes(['ST', 'FT', 'ET', 'WT', 'BT', 'CST', 'MST', 'IST','EST','DST','TST', 'NST', 'KST', 'TKST', 'GST', 'GWT', 'GAST', 'KYST', 'JBST', 'KFT', 'KWT', 'MT', 'RTT', 'KKT'] + @@tables.keys)
